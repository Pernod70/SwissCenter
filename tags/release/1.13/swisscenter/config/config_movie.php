 ...
 *************************************************************************************************/
  ...
  function movie_info( $message = "")
  {
    ...
    echo "<h1>".str('MOVIE_EXTRA_TITLE')."</h1>";
    message($message);
    ...
    echo '<p><b>'.str('EXTRA_REFRESH_TITLE').'</b>
          <p>'.str('EXTRA_REFRESH_DETAILS').'
          <p><span class="stdformlabel">'.str('EXTRA_REFRESH_WARNING','"'.str('ORG_TITLE').'"').'</span>';
    form_submit(str('EXTRA_REFRESH_GO'),2);
    form_end();
  }
