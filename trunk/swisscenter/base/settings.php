...
#-------------------------------------------------------------------------------------------------
# Set a suitable locale to ensure locale aware functions such as basename() function correctly
# with multibyte character paths. Some systems (QNAP) do not set a suitable default locale.
#-------------------------------------------------------------------------------------------------
