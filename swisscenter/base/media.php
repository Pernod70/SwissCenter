...
function process_mp3( $dir, $id, $file)
{
  ...
  $data     = array();
  $getID3   = new getID3;
  $getID3->setOption(array('encoding' => 'UTF-8', 'option_tags_html' => false));
...
function process_photo( $dir, $id, $file)
{
  ...
  if ( ! isset($id3['error']) )
  {
    if (in_array( $id3['fileformat'], media_exts_with_GetID3_support() ))
    {
      ...
      if (isset($id3["iptc"]))
      {
        send_to_log(5,'Found IPTC data : Yes',$id3['iptc']);
      ...
      if (isset($id3['xmp']))
      {
        send_to_log(5,'Found XMP data : Yes',$id3['xmp']);
        ...
        set_var($iptcxmp['location'],       implode(',',$id3['xmp']['prefix15']['Location']));
