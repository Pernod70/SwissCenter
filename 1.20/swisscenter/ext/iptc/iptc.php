...
// | (modified for inclusion in the SwissCenter project by Nigel Barnes)
// +----------------------------------------------------------------------+
//
...
class Image_IPTC
{
  ...
  function _lookupTag($sTag)
  {
    ...
    switch ($sTag)
    {
      case 'object_attribute_reference':
        $nTag = 4;
        break;
      ...
      case 'content_location_code':
        $nTag = 26;
        break;

      case 'content_location_name':
        $nTag = 27;
        break;
      ...
      case 'digital_creation_date':
        $nTag = 62;
        break;

      case 'digital_creation_time':
        $nTag = 63;
        break;
